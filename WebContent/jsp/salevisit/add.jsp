...
<BODY>
	<s:form id="form1" name="form1" action="saleVisit_add" namespace="/"
				...
				<TR>
					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						...
						<TABLE cellSpacing=0 cellPadding=5 border=0>
							...
							<TR>
								<td>拜访时间：</td>
								<td><s:textfield cssClass="textbox" cssStyle="WIDTH: 180px"
										maxlength="50" name="visit_time" id="visit_time"></s:textfield></td>
								<td>拜访地点 ：</td>
								<td><s:textfield cssClass="textbox" cssStyle="WIDTH: 180px"
										maxlength="50" name="visit_addr"></s:textfield></td>
							</TR>
							<TR>

								<td>拜访详情 ：</td>
								<td><s:textfield cssClass="textbox" cssStyle="WIDTH: 180px"
										maxlength="50" name="visit_detail"></s:textfield></td>
								<td>下次拜访时间 ：</td>
								<td><s:textfield cssClass="textbox" cssStyle="WIDTH: 180px"
										maxlength="50" name="visit_nexttime" id="visit_nexttime"></s:textfield></td>
							</TR>
							<tr>
